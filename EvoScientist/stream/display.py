...
def _resolve_hitl_approval(
    ...
    # Explicit session "approve all" (the user chose it interactively) blanket-
    # approves everything for the rest of the session, including the dangerous
    # set — a stronger, informed opt-in than unattended ``auto_approve``, which
    # still refuses the dangerous set below because no human is watching.
